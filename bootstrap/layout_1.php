...
<head>
    ...
    <style>
        ...
        .container-md { background-color: blue; }
        .container-lg { background-color: greenyellow; }
        .container-xl { background-color: palegoldenrod; }
        .container-xxl { background-color: aquamarine; }
        .container-fluid { background-color: gray; }
    </style>
</head>
<body>
