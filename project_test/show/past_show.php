...
<body>
    ...
    <div id="container">
        ...
        <div class="show_ul">
            <ul>
                <li><a href="current_show.php?gal_id=<?= $gal_id ?>">현재전시</a></li>
                <li><a href="past_show.php?gal_id=<?= $gal_id ?>">지난전시</a></li>
            </ul>
        </div>
        <section>
            <?php foreach($list as $item) { ?>
                <div class="poster_grid">
                    <!-- 디테일 링크로 바꾸기 -->
                    <a href="show_detail.php?s_id=<?= $item['s_id'] ?>"><img src="../images/<?= $item['s_post'] ?>" alt="전시1"></a>
